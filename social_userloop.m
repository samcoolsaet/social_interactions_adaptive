...
TrialRecord.User.max_block = 41; % TrialRecord.User.button_progression_factor * 3 ...
...
if TrialRecord.CurrentTrialNumber == 0
    ...
    stimulusList('C:\sam\agent_patient', TrialRecord.User.generalizing);
end
...
TrialRecord.User.movie = strcat('C:\sam\agent_patient\stimuli\',... 
...
TrialRecord.User.frame = strcat('C:\sam\agent_patient\frames\',... 
    TrialRecord.User.structure(TrialRecord.User.struct_index).folder, '\', ...
